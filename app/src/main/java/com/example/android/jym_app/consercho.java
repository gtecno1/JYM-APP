...
public class consercho extends AppCompatActivity {


    ArrayList<String> h= new ArrayList<String>();;
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_consercho);
    ...
    public void main_bb44(View view){
        Thread  tr = new Thread(){

            public void run(){
                EditText bus=(EditText) findViewById(R.id.editText6);
    ...
    public void main_aa44(View view){
        Thread  tr = new Thread(){
    ...
    public String leer(String id){
        ...
        String parametros = "?chofer=" + id;
        HttpGet httpget = new HttpGet("http://192.168.43.87:80/www/android/Getserc.php"+parametros);
